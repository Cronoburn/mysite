...
function my_authorizer_add_branding_option( $branding_options ) {
        $new_branding_option = array(
	                ...
	                'css_url' =>  '/opt/wordpress/wp-content/plugins/authorizer/sample-theme-add-branding/extend/authorizer/example/extend/authorizer/example/css/example.css',
	                'js_url' =>  '/opt/wordpress/wp-content/plugins/authorizer/sample-theme-add-branding/extend/authorizer/example/extend/authorizer/example/js/example.js',
		        );
